...
A live demo of the project is available at [https://bocilindo.pages.dev](https://bocilindo.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bocil indo`)
...
1. Fork the [repository](https://github.com/bokoraguno/bocilindo/fork) on GitHub.
